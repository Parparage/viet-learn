...
export default function HomeScreen({ vocabulary, progress, streak, onStartSession, onVocabUpdate }) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col max-w-lg mx-auto">
      ...
      <header className="bg-red-600 text-white px-4 py-4 shadow-md">
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-red-200">{streak.sessionsThisWeek} sessions cette semaine</p>
          </div>
        </div>
      ...
      <main className="flex-1 px-4 py-5 overflow-y-auto">
        ...
        <section className="mb-6">
          ...
          <button
            onClick={() => onStartSession(vocabulary, 'Tout le vocabulaire')}
          ...
          <div className="grid grid-cols-2 gap-3">
            {themes.map(theme => {
              ...
              return (
                <button
                  key={theme}
                  onClick={() => onStartSession(themeWords, theme)}
        ...
        <section className="mt-6">
          ...
          <p className="text-xs text-gray-400 text-center mt-2">
            Importez votre fichier pour ajouter de nouveaux mots
          </p>
        </section>
